...
namespace XorCompileTime
{
	...
	public:
		template <size_t... Is>
		constexpr __forceinline eYMvuaTG1s(const char* str, std::index_sequence< Is... >) : _key(RandomChar< K >::value), _encrypted{ enc(str[Is])... } {}
	...
	public:
		template <size_t... Is>
		constexpr __forceinline eYMvuaTG1sW(const wchar_t* str, std::index_sequence< Is... >) : _key(RandomCharW< K >::value), _encrypted{ enc(str[Is])... } {}
...
#define _xor(s) (XorCompileTime::eYMvuaTG1s<sizeof( s ) - 1,__COUNTER__>(s, std::make_index_sequence<sizeof(s) - 1>()).decrypt())
#define _xorw(s) (XorCompileTime::eYMvuaTG1sW<sizeof( s ) - 1,__COUNTER__>(s, std::make_index_sequence<sizeof(s) - 1>()).decrypt())
}
